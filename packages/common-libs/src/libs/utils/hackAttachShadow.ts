...
interface CustomElement extends Element {
  _attachShadow: (options: ShadowRootInit) => ShadowRoot
}
...
function hackAttachShadow() {
  ...
  try {
    ...
    const elementPrototype = window.Element.prototype as CustomElement

    elementPrototype._attachShadow = window.Element.prototype.attachShadow
    elementPrototype.attachShadow = function () {
      ...
      const shadowRoot = this._attachShadow.apply(this, arg as any)
      // 存一份shadowDomList
