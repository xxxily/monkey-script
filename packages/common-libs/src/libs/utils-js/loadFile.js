...
const loadCss = (src, callback) => loadFile('link', src, callback)

const loadIframe = (src, callback, beforeAppend, appendDom) => loadFile('iframe', src, callback, beforeAppend, appendDom)
